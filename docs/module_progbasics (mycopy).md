...
METHODS: 
List index, negative indexing - giving an index to each element in the list, starting with a zero.
...
If I search for installing something with ubuntu, there is usually a step-by-step description on how to do it.
